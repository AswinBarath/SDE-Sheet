...
public class Q64_SearchRotatedSortedArray {
	...
	public static int search(int[] nums, int target) {
		...
		// i.e, we know that all elements from start till pivot are going to be bigger
		// than target
		return binarySearch(nums, target, pivot + 1, nums.length - 1);
	}

	// this will not work for duplicate values (for 1.)
	...
	// this will work for duplicate values (for 2.)
